...
PopDenFinalRast <- readRDS('~/Dropbox/Aarhus Assistant Professor/Projects/4. PopulationDensity-LGMtoNow/Results/90Percent/MinPopPopDen90.RData')
...
IceList <- stack(IceList[[1]],
                 ...
                 IceList[[20]],
                 IceList[[24]])
pdf("~/Desktop/SuppFigS2.pdf",width=9,height = 9)                
print(
  rasterVis::levelplot(PopDenMap,
                       ...
                       colorkey=list(at=seq(0,26,length.out=101),
                                     labels = list(at = seq(0,26,by=5)),
